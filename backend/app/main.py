...
from app.routers import web3_content as web3_content_router
...
app.add_middleware(
    ...
    limits={
        ("POST", "/residents/import"): IMPORT_MAX_MULTIPART_BODY_BYTES,
        ("POST", "/web3/content"): settings.web3_content_max_bytes + 1024 * 1024,
    },
...
app.include_router(web3_content_router.router)
