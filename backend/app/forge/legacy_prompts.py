"""
Prompt templates for the LEGACY Forge (炼化器) LLM pipeline
(app/forge/legacy_pipeline.py — the /forge/start|answer|quick|status endpoints).

Prompts for the canonical stage pipeline (app/forge/pipeline.py) live in
app/forge/prompts.py. The two sets share no symbols.

Moved verbatim from app/llm/forge_prompts.py (P1-6 file split); that module
