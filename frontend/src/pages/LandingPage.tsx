    ...
    <div className="marketing-site" id="top">
      <header className="site-header" data-scrolled={scrolled}>
        ...
        >
          ...
          <Link className="site-nav__mobile-entry" to={enterTo} onClick={closeMenu}>进入世界</Link>
        </nav>

        <div className="site-header__actions">
          <Link className="site-header__login" to={enterTo}>{token ? '进入世界' : '登录'}</Link>
          <button
            ref={menuButtonRef}
        ...
        <section className="site-hero" aria-labelledby="hero-title">
          ...
          <div className="site-hero__content">
            ...
            <div className="site-hero__actions">
              <Link className="site-button site-button--primary" to={enterTo}>
      ...
      <footer className="site-footer">
        ...
        <div className="site-footer__links">
          ...
          <div><span>CREATE</span><a href="#forge">锻造</a><Link to={enterTo}>{token ? '进入世界' : '登录'}</Link></div>
        </div>
