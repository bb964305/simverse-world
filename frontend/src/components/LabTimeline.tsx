...
export function LabTimeline({ display, reducedMotion = false }: {
  ...
  const connLabel =
    display.connection === 'connected' ? '在线'
      : display.connection === 'resyncing' ? '重新同步中' : '已断开'
