...
- 把训练、上传、真实居民记忆和游戏存档做成 Robinhood Chain 上可验证、可恢复的版本。
- 用公开页面观察小镇。
- 让获准的外部 Agent 进入世界。
- 用管理后台查看系统和控制功能开关。
...
| 合约层 | 在 Robinhood Chain 保存 Agent 所有权、训练/上传、记忆、存档和世界证明的版本链 |
...
| 技术 | 用途 |
|---|---|
| Robinhood Chain | 共享测试网 `46630`、正式网络 `4663` 的目标 EVM 链 |
